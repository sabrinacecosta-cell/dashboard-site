-- Correção: o grupo 1055 foi decrementado por engano (240 -> 239) na migration
-- update_grupo_1055_prazo_239.sql, mas o prazo_restante real ainda é 240.
-- Este script reverte para 240 e recalcula as parcelas.
