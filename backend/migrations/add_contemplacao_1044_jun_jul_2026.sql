...
-- A média PRINCIPAL é a de últimos 12 meses (definição do negócio), então
-- media_contemplacao recebe o valor de 12 meses. Fica numa única linha (a mais
-- recente) porque o resumo usa MAX(...).
UPDATE contemplacao SET media_contemplacao = NULL, media_contemplacao_6m = NULL
WHERE grupo = 1044;
UPDATE contemplacao SET media_contemplacao = '0.0422', media_contemplacao_6m = '0.0190'
WHERE grupo = 1044 AND mes = 'Julho/2026';

UPDATE simulador_grupos
SET media_contemplacao = 0.042208, media_contemplacao_6m = 0.018957, media_contemplacao_12m = 0.042208
