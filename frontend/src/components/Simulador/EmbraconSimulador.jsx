            ...
            <tbody>
              {linhas.map(l => (
                <tr key={l.id}>
                  ...
                  <td>{l.prazo} meses</td>
                  <td>{l.qtde}</td>
                  <td>{formatarMoeda(l.credito * l.qtde)}</td>
              ...
              {linhas.length === 0 && (
                <tr>
                  <td colSpan={7} style={{ textAlign: 'center', color: 'var(--text-secondary)', padding: '18px' }}>
